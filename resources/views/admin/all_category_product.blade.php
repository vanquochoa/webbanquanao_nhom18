                        ...
                        @foreach ($all_category_product as $item)
                            <tr>
                                ...
                                @if ($item->category_status == 0)
                                    <td><a href="{{ URL::to('/unactive-category-product/' . $item->category_id) }}"><span
                                                class="fa fa-thumbs-down"> Ẩn</span></a></td>
                                @else
                                    <td>
                                        <a href="{{ URL::to('/active-category-product/' . $item->category_id) }}"><span
                                ...
                                <td>
                                    ...
                                    <a onclick="return confirm('Bạn có chắc muốn xóa?')"
                                        href="{{ URL::to('/delete-category-product/' . $item->category_id) }}"><i
