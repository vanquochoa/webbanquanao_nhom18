...
font-awesome icons --}}
    ...
    <script src="{{ asset('backend/js/raphael.js') }}"></script>
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            @if (isset($admin_info))
                            <span class="username">{{$admin_info->admin_name}}</span>
                            @endif
        ...
        <section id="main-content">
            ...
            <div class="footer">
                <div class="wthree-copyright">
                    <p>Liên hệ với chúng tôi qua <a href="https://www.facebook.com/vanquochoa">Văn Quốc Hòa</a>
                    </p>
                </div>
            </div>
            <!-- / footer -->
